/* Problem - 12: Return true if the string in the first element of the array contains all of the letters of the string in the second element of the array
...
// Solution: Using includes method with Es6
